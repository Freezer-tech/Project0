...
def main():
    ...
    # Access values of argument 2 by printing it
    ...
    # I use the 02d formatting specification, to format the value as 05 instead of 5 for example
    print("Total Elapsed Runtime: {:02d}:{:02d}:{:02d}".format(hours, minutes, seconds))
