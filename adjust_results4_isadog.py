...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    with open(dogfile, "r") as infile:
        ...
        while line != "":
            # Process line by stripping newline character from line
            line = line.strip()
            ...
            # Reads in next line in file to be processed with the while loop
    ...
    for key in results_dic:
        ...
        if results_dic[key][0] in dognames_dic:
            ...
            # Append (1, 0) because only the pet label is a dog
            else:
                results_dic[key].extend((1, 0))
        # Pet Image Label IS NOT a Dog image (e.g., NOT found in dognames_dic)
        else:
            # Classifier Label IS image of Dog (e.g., found in dognames_dic)
            # Append (0, 1) because only the classifier label is a dog
            if results_dic[key][1] in dognames_dic:
...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    with open(dogfile, "r") as infile:
        ...
        while line != "":
            # Process line by stripping newline character from line
            line = line.strip()
            # nice use of strip to remove empty spaces around string you can see more details here
